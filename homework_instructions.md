...
//create bamazon.sql document and type everything from 1 to 4 in this file
...
//Go to terminal and navigate to mysql:
//mysql -u root;
//SOURCE bamazon.sql;
//you will have db and table created
//exit;
5. Then create a Node application called `bamazonCustomer.js`. Running this application will first display all of the items available for sale. Include the ids, names, and prices of products for sale.
//navigate to your folder in terminal
//touch bamazonCustomer.js;
//npm init -y;  //This command installs a package json file, and any packages that it depends on. This installs 
//package-lock.json
//npm install mysql;
//cat package-lock.json     //to see dependencies (version ^2.16.0) - ^ means the latest version
